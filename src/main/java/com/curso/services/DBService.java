...
public class DBService {
    ...
    public void initDB(){
        ...
        GrupoProduto grupo02 = new GrupoProduto(0,"Alimenticio", Status.ATIVO);
        ...
        Produto produto04 = new Produto(0,"4444", "Sabao em po OMO", new BigDecimal("400"), new BigDecimal("15.5"),
                LocalDate.now(),grupo02,Status.ATIVO);
